...
This is a repository containing code for multiple DSA questions which i will be solving throughout my coding journey.
Author - Mohit Sharma
...
**2-Dec-2025 :** [missing and repeated values in matrix]
...
**25-August-2026 :**(LinkedList)-[Find the first node of the loop inside the linked list (StartingNodeOfLoop.cpp)]**STREAK-DAY-31**
...
**---------------------------------------------------------- BEGINNING OF THE WINTER ARC -----------------------------------------------------------**

**1-September-2026 :**(LinkedList)-[Check the intersection node in the linked list **INCOMPLETE** (IntersectionNodeInLL.cpp)]**STREAK-DAY-37**
...
**4-September-2026 :**(LinkedList)-[Delete all the target nodes from the doubly linked list (DeleteTargetNodesInDoubleLL.cpp), Find all the pairs with given sum in the dounly linked list (FindGivenSumPairsInDoublyLL.cpp), Remove all the duplicates from the given doubly linked list (RemoveDuplicatesFromDoublyLL.cpp)]**STREAK-DAY-40**
